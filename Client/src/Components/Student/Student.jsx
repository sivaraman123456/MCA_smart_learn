...
const response=await fetch(`http://localhost:5000/api/auth/all_users`,{method:"GET"})
...
const removeData=async(id)=>{
  console.log("id:",id);
  const remove=await axios.delete(`http://localhost:5000/api/auth/delete_user/${id}`)
console.log(remove);
